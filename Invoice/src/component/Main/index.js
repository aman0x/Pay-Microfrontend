    ...
    <>
      ...
      <div className="md:hidden px-4 mt-4 mb-20 w-full">
        ...
        <div className="flex w-full justify-center">
          <div className="bg-white rounded-3xl w-96 shadow-md p-5 mt-8 mb-4">
            <div className="flex justify-between items-center w-full pb-4 gap-4">
              ...
              <div className="flex-1 poppins-semibold justify-center items-center">
                <p>{invoices[0]?.beneficiary_name}</p>
              </div>
              <div className="color-linear poppins-semibold">
                <p className="text-right">₹ {invoices[0]?.amount}</p>
              </div>
            </div>
            <div className="flex justify-between items-center w-full pb-4 gap-4">
              ...
              <p className="text-[#787D81] text-right poppins-semibold">
                {moment(invoices[0]?.created_at).format("DD MM YYYY HH:mm")}
              </p>
            </div>
            <div className="flex justify-between items-center w-full pb-4 gap-4">
            ...
            <div className="flex gap-4 w-full pt-2">
              <div className="flex-1 primary-linear-gr-bg p-[1.5px] rounded-xl ">
                <button
                  ...
                  onClick={() => { }}
                >
                  <span className="poppins-light uppercase text-[10px]">
                    Details
                  </span>
              ...
              <div className="flex-1 bg-[#232B31] p-[1.5px] rounded-xl">
                <button
                  ...
                  onClick={() => { }}
                >
                  <span className="poppins-light uppercase text-[10px] text-white">
                    Pay
                  </span>
        ...
        <div className="mt-4 flex justify-center items-center w-full">
          {/* Temporary solution */}
          <img src="/images/nav.svg" alt="Temp" />
        </div>
