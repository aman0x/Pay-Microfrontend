             ...
             <div className="flex gap-3 poppins-light text-[14px] items-center mt-2">
                ...
                <div className="w-80 mx-4">
                  <div class="relative w-full">
                      <input type="text" id="voice-search" class="bg-[#DFE0E2] border border-gray-300 text-gray-900 text-sm rounded-2xl block w-full  p-2" placeholder="Search for invoices..." required />
