        ...
        >
            ...
            {navIndex===1?
                ...
                <span className={`${isNavOpen?"":"nav-element"}`}>
                    ...
                    <path d="M12.15 3.99957C12.15 5.93257 10.7397 7.49957 8.99999 7.49957C7.2603 7.49957 5.85 5.93257 5.85 3.99957C5.85 2.06657 7.2603 0.499573 8.99999 0.499573C10.7397 0.499573 12.15 2.06657 12.15 3.99957Z" fill="#CDCED1"/>
                    <path d="M14.4 12.9996C14.4 14.9326 11.9823 16.4996 8.99999 16.4996C6.01766 16.4996 3.6 14.9326 3.6 12.9996C3.6 11.0666 6.01766 9.49957 8.99999 9.49957C11.9823 9.49957 14.4 11.0666 14.4 12.9996Z" fill="#CDCED1"/>
                    <path d="M4.60986 1.49957C4.76957 1.49957 4.9255 1.51698 5.07606 1.55013C4.70925 2.27403 4.50001 3.10965 4.50001 3.99957C4.50001 4.86782 4.69919 5.68439 5.04954 6.39593C4.90722 6.4254 4.76022 6.44083 4.60986 6.44083C3.33688 6.44083 2.30493 5.33469 2.30493 3.9702C2.30493 2.60571 3.33688 1.49957 4.60986 1.49957Z" fill="#CDCED1"/>
                    <path d="M3.1026 15.4856C2.59148 14.8067 2.25 13.9736 2.25 12.9996C2.25 12.0554 2.57091 11.2436 3.0562 10.5763C1.34199 10.7241 0 11.7658 0 13.029C0 14.304 1.36557 15.3534 3.1026 15.4856Z" fill="#CDCED1"/>
                    <path d="M13.4999 3.99957C13.4999 4.86782 13.3007 5.68439 12.9504 6.39593C13.0927 6.4254 13.2397 6.44083 13.3901 6.44083C14.6631 6.44083 15.695 5.33469 15.695 3.9702C15.695 2.60571 14.6631 1.49957 13.3901 1.49957C13.2303 1.49957 13.0745 1.51698 12.9239 1.55013C13.2906 2.27403 13.4999 3.10965 13.4999 3.99957Z" fill="#CDCED1"/>
                    <path d="M14.8973 15.4856C16.6343 15.3534 17.9999 14.304 17.9999 13.029C17.9999 11.7658 16.6579 10.7241 14.9437 10.5763C15.429 11.2436 15.7499 12.0554 15.7499 12.9996C15.7499 13.9736 15.4085 14.8067 14.8973 15.4856Z" fill="#CDCED1"/>
                    </svg>

                </span>
                    <p className="hover:text-black hover:font-semibold mr-2">User Activity</p>
                    {/* <div className="relative primary-linear-gr-bg  p-[1.5px] rounded-2xl">
                    <div className="bg-black-primary rounded-xl py-0.5 px-2 text-xs">1 New</div>
                    </div> */}
                </button>
                ...
                <span className={`${isNavOpen?"":"nav-element"}`}>
                    ...
                    <path d="M16 3.74156C16 4.2174 15.568 4.60672 15.04 4.60672H0.96C0.432 4.60672 0 4.2174 0 3.74156V3.73435C0 2.08335 1.48 0.749573 3.312 0.749573H12.68C14.512 0.749573 16 2.09056 16 3.74156Z" fill="#CDCED1"/>
                    <path d="M0 6.57721V10.7781C0 12.6983 1.48 14.2496 3.312 14.2496H12.68C14.512 14.2496 16 12.6899 16 10.7698V6.57721C16 6.0238 15.568 5.571 15.04 5.571H0.96C0.432 5.571 0 6.0238 0 6.57721ZM4.8 11.4406H3.2C2.872 11.4406 2.6 11.1555 2.6 10.8117C2.6 10.4679 2.872 10.1828 3.2 10.1828H4.8C5.128 10.1828 5.4 10.4679 5.4 10.8117C5.4 11.1555 5.128 11.4406 4.8 11.4406ZM10 11.4406H6.8C6.472 11.4406 6.2 11.1555 6.2 10.8117C6.2 10.4679 6.472 10.1828 6.8 10.1828H10C10.328 10.1828 10.6 10.4679 10.6 10.8117C10.6 11.1555 10.328 11.4406 10 11.4406Z" fill="#CDCED1"/>
                    </svg>
                </span>
                    <p className=" hover:text-black hover:font-semibold mr-5">Transaction</p>
                    {/* <div className="relative primary-linear-gr-bg  p-[1.5px] rounded-2xl">
                    <div className="bg-black-primary rounded-xl py-0.5 px-2 text-xs">1 New</div>
                    </div> */}
                </button>
