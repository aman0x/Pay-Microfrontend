  ...
  return (
    <div className="p-[0.8rem] mt-5 flex flex-col gap-4 ">
      <div>
        ...
        <div className="poppins-regular text-xs text-[#B6B8BA]">
          Set Option to show last:
        </div>
      </div>
      <div className="flex flex-col  gap-2 poppins-light text-sm text-gray-600 ">
        <div className="text-[10px] mt-2 text-[#A3A6A9]">Select Card : </div>
        <div className="flex justify-between">
          <div className="flex gap-1 items-center">
            ...
            <div className="poppins-semibold text-xs text-[#787D81]">**** **** **** 1001</div>
          </div>
          <div
            onClick={() => {
      ...
      <div className="flex w-72  bg-[#F0F1F2] py-[8px] rounded-xl justify-evenly px-2 ">
        <button
          className="px-2 py-2 rounded-xl poppins-light text-xs"
          style={{
      ...
      <div className="text-[#B6B8BA] text-xs poppins-regular">
...
function CardsMenu() {
  ...
  return (
    <div className="w-[100%] bg-white rounded-2xl shadow-lg  py-[1rem] px-[1.2rem] gap-4">
  ...
  return (
    <div>
      <div className="mt-2 mb-4">
        <div className="poppins-semibold text-base">General Report</div>
        <div className="poppins-regular text-xs text-[#B6B8BA]">
