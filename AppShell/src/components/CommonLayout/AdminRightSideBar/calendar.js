...
function CalenderStats(){
    ...
    return(
        ...
        {isCalenderSheetOpen?
        <div className="absolute right-5 top-[18px] rounded-[50%] p-1 bg-primary calendar-btn" onClick={()=>setCalenderSheet(false)}>
        ...
        :
        <div className="absolute right-5 top-[18px] rounded-[50%] p-1 bg-primary calendar-btn" onClick={()=>setCalenderSheet(true)}>
