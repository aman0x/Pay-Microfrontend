...
export function DropMenu({ setDropMenu, navigate }) {
    ...
    return (
        <div  ref={menuRef}  className="absolute end-0 top-0 bg-white rounded-[20px] p-[1rem] w-[295px] z-50 cursor-pointer shadow-md">
            ...
            <div className="p-[2rem] flex flex-col gap-4 ">
                ...
                <div
                    ...
                    <div>
                        <svg    className="fill-[#B6B8BA] group-hover:fill-black" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    ...
                    className="flex items-center gap-4 text-[#A3A6A9] text-sm poppins-light hover:text-[black] hover:font-bold group">
                    <div>
                        <svg    className="fill-[#B6B8BA] group-hover:fill-black" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    ...
                    className="flex items-center gap-4 text-[#A3A6A9] text-sm poppins-light hover:text-[black] hover:font-bold group">
                    <div>
                        <svg    className="fill-[#B6B8BA] group-hover:fill-black" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    ...
                    className="flex items-center gap-4 text-[#A3A6A9] text-sm poppins-light hover:text-[black] hover:font-bold group">
                    <div>
                        <svg    className="fill-[#B6B8BA] group-hover:fill-black" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    ...
                    className="flex items-center gap-4 text-[#A3A6A9] text-sm poppins-light hover:text-[black] hover:font-bold group">
                    <div>
                        <svg    className="fill-[#B6B8BA] group-hover:fill-black" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
