...
function SpendData({ monthStats }) {
    ...
    return (
        ...
        <div className="flex flex-col mt-4 gap-2 poppins-light text-sm text-gray-600 ">
            <div className="poppins-semibold text-sm text-[#787D81">Total Month Spendings</div>
            <div className="text-[10px] text-[#A3A6A9] poppins-regular mt-2">Select Card : </div>
            ...
            <div className="h-[12rem]">
                <ChartComp data1={monthStats.monthly_expenses} data2={monthStats.monthly_incomes} />
            </div>
            <div className="flex flex-col gap-1 my-2">
                <div className="flex justify-between items-center poppins-light text-[#787D81] text-[10px]">
                ...
                <div className="flex justify-between poppins-light text-[#787D81] text-[10px]">
                    <div className="flex justify-between items-center gap-1">
