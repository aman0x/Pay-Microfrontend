                ...
                <div className="flex flex-col mt-2 gap-2">
                    <div
                        ...
                        <div className="flex flex-col gap-1">
                            <p className="text-[#A3A6A9] poppins-regular text-xs">Total Payments</p>
                            <p className="poppins-semibold text-lg">{totalStats.total_payments}</p>
                        </div>
                    ...
                    <div
                        ...
                        <div className="flex flex-col gap-1">
                            <p className="text-[#A3A6A9] poppins-regular text-xs">Invoice Sended</p>
                            <p className="poppins-semibold text-lg">{totalStats.invoice_sent}</p>
                        </div>
                        <div className="flex gap-4 items-center">
                            <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect y="0.5" width="40" height="40" rx="20" fill="url(#paint0_linear_1_4412)" fill-opacity="0.26" />
                                <g clip-path="url(#clip0_1_4412)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.0472 12.9775C14.7878 12.3526 15.7919 12.0011 16.8393 12H23.1603C24.2077 12.0011 25.2118 12.3526 25.9524 12.9775C26.693 13.6024 27.1096 14.4496 27.1109 15.3333V27.3332C27.1105 27.4543 27.0711 27.573 26.9968 27.6766C26.9225 27.7802 26.8162 27.8648 26.6892 27.9213C26.5623 27.9777 26.4195 28.004 26.2762 27.9971C26.1329 27.9903 25.9945 27.9507 25.8759 27.8825L24.2167 26.9245L22.5574 27.8832C22.4259 27.9593 22.2701 28 22.1106 28C21.9511 28 21.7953 27.9593 21.6638 27.8832L20.0045 26.9238L18.3453 27.8832C18.2138 27.9591 18.0582 27.9998 17.8988 27.9998C17.7395 27.9998 17.5839 27.9591 17.4524 27.8832L15.7884 26.9238L14.1244 27.8832C14.0058 27.9516 13.8672 27.9913 13.7237 27.9982C13.5803 28.0051 13.4373 27.9789 13.3102 27.9223C13.183 27.8657 13.0766 27.781 13.0024 27.6772C12.9281 27.5734 12.8888 27.4544 12.8887 27.3332V15.3333C12.8899 14.4496 13.3066 13.6024 14.0472 12.9775ZM19.9998 23.5556C22.4544 23.5556 24.4442 21.5657 24.4442 19.1111C24.4442 16.6565 22.4544 14.6667 19.9998 14.6667C17.5452 14.6667 15.5553 16.6565 15.5553 19.1111C15.5553 21.5657 17.5452 23.5556 19.9998 23.5556Z" fill="url(#paint1_linear_1_4412)" />
                                    <path d="M19.9998 21.7778L19.9998 16.4445M19.9998 16.4445L22.6665 19.1112M19.9998 16.4445L17.3332 19.1112" stroke="url(#paint2_linear_1_4412)" stroke-width="0.833333" stroke-linecap="round" />
                                </g>
                                <defs>
                                    <linearGradient id="paint0_linear_1_4412" x1="-6.37708" y1="24.0556" x2="46.665" y2="11.9181" gradientUnits="userSpaceOnUse">
                                    ...
                                    <linearGradient id="paint1_linear_1_4412" x1="10.6213" y1="21.4222" x2="29.6797" y2="17.5457" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#F6DEC6" />
                                        <stop offset="0.47" stop-color="#E872D4" />
                                        <stop offset="0.656667" stop-color="#C190D9" />
                                        <stop offset="0.881578" stop-color="#A2DCFE" />
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_1_4412" x1="19.5258" y1="22.6281" x2="21.1441" y2="15.5558" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#F6DEC6" />
                                        <stop offset="0.47" stop-color="#E872D4" />
                                        <stop offset="0.656667" stop-color="#C190D9" />
                                        <stop offset="0.881578" stop-color="#A2DCFE" />
                    ...
                    <div
                        ...
                        className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl cursor-pointer">
                        <div className="flex flex-col gap-1">
                            <p className="text-[#A3A6A9] poppins-regular text-xs">Invoice Received</p>
                            <p className="poppins-semibold text-lg">{totalStats.invoice_received}</p>
                        </div>
                        <div className="flex gap-4 items-center">
                            <div className="primary-linear-gr-bg-light p-3 rounded-[50%]">
