...
function SecondaryTopBar({ btn1 = "", btn2 = "" }) {
    ...
    return (
        <div className="hide md:flex  items-center justify-between w-full pt-4 px-2 my-1 gap-2">
            ...
            </div>
            {
                    ...
                    (location.pathname.startsWith('/invoice/send-invoice')) 
                    ?
...
function getTopName(pathname = "/payment") {
    if (pathname === "/invoice/send-invoice") {
        return "New Invoice"
    }
    else if(pathname.startsWith("/report")){
        return "Reports"
    }
    else if(pathname === "/invoice/invoice-detail"){
    ...
    else if(pathname === "/dashboard/card/add-card"){
        return "Add New Card"
    }
