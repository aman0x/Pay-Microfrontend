               ...
               <div className="flex flex-row gap-12 justify-center">
                {
                    ...
                    <rect x="0.5" width="76" height="76" rx="38" fill="url(#paint0_linear_522_6287)" fillOpacity="0.2"/>
                ...
                <p className=" text-sm text-center poppins-extralight text-gray-500">INDIVIDUAL</p>
                 ...
                 <div className="gap-2 flex flex-col">
                    <svg width="77" height="76" viewBox="0 0 77 76" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" width="76" height="76" rx="38" fill="url(#paint0_linear_1_18356)" fillOpacity="0.2"/>
