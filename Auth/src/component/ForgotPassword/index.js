...
export default function ForgotPassword(){
    ...
    return(
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Reset Your Account</h2>
      </div>
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          <NavLink to={"/accounts/login"} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Back To Login</NavLink>
        </p>
      </div>
    </div>
    )
