...
export default function SignUpUser(){
    ...
    return(
        ...
        <div className="flex min-h-full flex-col ">
          ...
          <Formik
            initialValues={{ first_name: '',middle_name:'',last_name:'', password: '' ,phone:'',email:'',password2:''}}
            validate={values => {
              const errors = {};
              ...
              if(!values.email && pageIndex===2){
                ...
                !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.email) && pageIndex===2
              ) {
              ...
              if(values.password2!==values.password && pageIndex===2){
                errors.password2 = "Password didn't match with entered password!!"
              }
              return errors;
            }}
              ...
              <form className="space-y-4 mt-4">
                {
                  ...
                  <div className='flex flex-col gap-3 '>
                    <div>
                      ...
                      <div className='text-red-400 text-xs'>{errors.first_name && touched.first_name && errors.first_name}</div>
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none gap-2">
                    <IoPerson color='grey' />
                ...
                <div className='flex flex-col gap-3 '>
                  <div>
                    ...
                    <div className='text-red-400 text-xs'>{errors.phone && touched.phone && errors.phone}</div>
                  </div>
                  <div>
                    <div className="relative">
                    <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none gap-2">
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <PiLineVertical color='gray' />
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full ps-14 p-3.5 " placeholder="Enter Password..."/>
                    ...
                    <div className='text-red-400 text-xs'>{errors.password && touched.password && errors.password}</div>
                  </div>
                  <div>
                    <div className="relative">
                      <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                      ...
                      <PiLineVertical color='gray' />
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full ps-14 p-3.5 " placeholder="Confirm Password..."/>
                    ...
                    <div className='text-red-400 text-xs'>{errors.password2 && touched.password2 && errors.password2}</div>
                  </div>
