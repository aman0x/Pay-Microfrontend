...
export default function SignUpUser(){
    ...
    return(
        ...
        <div>
            ...
            <div className="mt-2">
                <input id="Name" name="Name" type="text" onChange={(e)=>setName(e.target.value)} required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
            </div>
            <div>
        ...
        <div className="flex items-center justify-center mt-4  bg-gray-100 dark:bg-gray-700">
        <p className="mx-4 text-center text-sm text-gray-500">
            Already have account?
            <NavLink to={"/accounts/login"} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">SignIn</NavLink>
        </p>
        </div>
