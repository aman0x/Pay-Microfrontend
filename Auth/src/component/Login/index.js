        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-sm ">
            ...
            <div className='mt-3'>
              <button type="submit"
                ...
                className="flex primary-btn items-center w-full justify-center rounded-xl bg-gray-950 px-3 p-4 text-sm font-semibold leading-7 text-white shadow-sm "><div> {withEmail?"Log In":"Send Otp"}</div>
