    ...
    return(
        <div className={`${reportIndex===2?'flex gap-4':''} mt-2`}>
            ...
            <div className="w-full  bg-white p-[1.5rem] rounded-2xl">
                ...
                <table className="w-full  rounded-2xl overflow-hidden mt-7">
                            ...
                            return(
                                ...
                                <td>
                                    <div className="flex items-center gap-3 td-element">
                                        <div className={`w-[12px]  h-[12px] rounded-[4px] ${isDateClicked?'primary-linear-gr-bg':'bg-white border-2'}`} onClick={()=>{setIsDateClicked(!isDateClicked)}}>
