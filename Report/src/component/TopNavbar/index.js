...
function DropMenu({setDropMenu,navigate}){
    ...
    return(
        <div className="absolute end-0 top-0 bg-white rounded-2xl p-[1rem] w-72 z-50">
            <div className="flex justify-end" onClick={()=>setDropMenu(false)}>
                <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 1L1 10" stroke="#232B31" stroke-linecap="round"/>
                <path d="M1 1L9 10" stroke="#232B31" stroke-linecap="round"/>
                </svg>
            </div>
            ...
            onClick={()=>{
             ...
             className="flex gap-4 text-[#A3A6A9] text-sm poppins-regular hover:text-[black] hover:font-bold">
                <div>
            ...
            <div className="flex gap-4 text-[#A3A6A9] text-sm poppins-regular hover:text-[black] hover:font-bold">
                <div>
