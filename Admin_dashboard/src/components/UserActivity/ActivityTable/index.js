       ...
       <FilterTableStats/>
        ...
        <table className="w-full  rounded-2xl overflow-hidden   ">
            <tr className="poppins-light text-xs text-white bg-black-primary items-center ">
                ...
                <td>
                    <div className="td-element1">Paid %</div>    
                </td>
            ...
            </tr>
            {
                transactions.map((transaction,i)=>{
                    return(
                        <tr key={i} className="text-xs poppins-regular" onClick={()=>navigate('/admin/users')}>
                        <td>
                        ...
                        <td>
                          <div className="td-element flex flex-col gap-1" >
                            <div className="flex">
