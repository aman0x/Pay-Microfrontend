  ...
  return (
    <div>
      <div className="flex flex-col gap-1 mt-2">
        <div className="text-[#787D81] poppins-semibold">Transactions List</div>
        <div className="poppins-light text-[#B6B8BA] text-sm">
          Click to Row for Transaction Details
        </div>
      </div>
      <div className="flex justify-between poppins-light text-[14px] items-center mt-2">
...
export default FilterTableStats;
