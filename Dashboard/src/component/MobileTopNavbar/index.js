...
function MobileTopNavbar() {
  ...
  return (
    <div className="z-10 flex items-center justify-between w-[100vw] px-4 pt-10 pb-6">
      <div>
        <img
          onClick={() => navigate("/")}
      ...
      <div className="flex gap-4 text-sm items-center">
        <div>
          <img
            ...
            src="/images/white-notification.svg"
            alt="Notification"
          />
        </div>
        <div
        ...
        <div className="relative">
          <button onClick={() => setDropMenu(true)}>
            <img src="/images/drop_menu.svg" alt="Dropdown" />
          </button>
          {isDropMenuOpen && (
