  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex w-full  bg-[#FFFF] py-[8px] rounded-xl justify-evenly px-2 ">
        <button
          className="px-9 py-2 rounded-xl poppins-light text-xs"
          style={{
            backgroundColor: reportIndex === 0 ? "#FFFF" : null,
            width: "45%",
            color: reportIndex === 0 ? "black" : "#A3A6A9",
            fontWeight: reportIndex === 0 ? "600" : "normal",
            boxShadow:
              reportIndex === 0
        ...
        <button
          ...
          style={{
            ...
            width: "45%",
            fontWeight: reportIndex === 1 ? "600" : "normal",
            boxShadow:
              reportIndex === 1
                ? "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px"
                : null,
        ...
        <button
          ...
          style={{
            ...
            width: "45%",
            color: reportIndex === 2 ? "black" : "#A3A6A9",
            fontWeight: reportIndex === 2 ? "600" : "normal",
            boxShadow:
              reportIndex === 2
                ? "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px"
                : null,
      ...
      <div className="flex poppins-light text-xs text-[#A3A6A9] gap-8 justify-center">
        <div className="text-xs">12 March 2024 - 25 March 2024 (14 days)</div>
