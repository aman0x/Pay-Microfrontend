...
//         </td>
//         <td>
//             <div className="td-element">{transaction.customer}</div>
//         </td>
//         <td>
...
function StatsTable({ transactionData, reportIndex = 0 }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-1">
        <div className="text-[#787D81] poppins-semibold text-base">Transactions List</div>
        <div className="poppins-light text-[#B6B8BA] text-xs">
          Click to Row for Transaction Details
        </div>
      </div>
      <div className="w-full overflow-x-auto">
        <div className="flex gap-3 poppins-light text-[14px] sm:items-center mb-6 w-full justify-between">
