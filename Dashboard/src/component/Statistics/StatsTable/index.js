  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-1">
        <div className="text-[#787D81] poppins-semibold text-base">
          Transactions List
        </div>
        <div className="poppins-light text-[#B6B8BA] text-xs">
          Click to Row for Transaction Details
        </div>
      </div>
      <>
        ...
        <div className="w-[29rem] lg:w-[28rem] xl:w-full  mt-2  overflow-x-auto">
          <table className="w-full rounded-2xl overflow-x-auto">
            <tr className="poppins-light text-xs text-white bg-[#232B31] items-center">
              ...
              <td>
                <div className="td-element1 text-[10px]">Customer</div>
              </td>
              <td>
                  ...
                  >
                    <td>
                      <div className="flex items-center gap-3 td-element text-[10px]">
                        <div className={`w-[12px]  h-[12px] rounded-[4px] ${isDateClicked||isRowSelected(i) ? 'primary-linear-gr-bg' : 'bg-white'}`} onClick={(e) => {
                          e.stopPropagation()
                          handleRowClick(i)
                          }}>
                    ...
                    <td><div className="td-element text-[10px]">{transaction.beneficiary_name}</div></td>
                    <td><div className="td-element text-[10px]">{transaction.transaction_type}</div></td>
                    ...
                    <td><div className="td-element text-[10px]">{transaction.transaction_amount}</div></td>
                    <td>
                      <div className="flex gap-6 items-center td-element text-[10px]">
                        <div>{transaction.transaction_commision}</div>
