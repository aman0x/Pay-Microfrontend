    ...
    <div className="grid xl:grid-cols-2 m-1  gap-4">
      <div className="bg-white rounded-2xl flex  p-[1.5rem] justify-between ">
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-1">
            <p className="text-[#A3A6A9] text-xs ">All Transaction</p>
            <p className="poppins-semibold text-lg">
              {stats.total_transactions ||
                stats.total_sent_invoices ||
                stats.total_received_invoices}
            </p>
            <p className="text-xs text-[#27A963]">
              +{" "}
              <span className="poppins-semibold">
                {stats.today_transactions ||
                  stats.today_sent_invoices ||
                  stats.today_received_invoices}
              </span>{" "}
              Today
            </p>
          </div>
      ...
      {reportIndex === 0 && (
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl h-[8.5rem]">
            <div className="flex flex-col gap-1">
              <p className="text-[#A3A6A9] poppins-light text-xs">
                Total Incomes
              </p>
              <p className="poppins-semibold text-lg">
                ₹ {stats.total_incomes}
              </p>
              <p className="text-[#27A963] text-xs">
                <span className="poppins-semibold">
                  + {stats.today_incomes}{" "}
                </span>
                Today
          ...
          <div className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl h-[8.5rem]">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[#E45757] text-xs">
                <span className="poppins-semibold">
      ...
      {reportIndex === 1 && (
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between  bg-white py-5 px-5 rounded-2xl h-[6rem]">
            <div className="flex flex-col gap-1">
              <p className="text-[#A3A6A9] text-xs">Total Succeeded in INR</p>
              <p className="poppins-semibold text-lg">
          ...
          <div className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl h-[6rem]">
            <div className="flex flex-col gap-1">
              <p className="text-[#A3A6A9] text-xs">Total InProgress in INR</p>
              <p className="poppins-semibold text-lg">
          ...
          <div className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl h-[6rem]">
            <div className="flex flex-col gap-1">
              <p className="text-[#A3A6A9] text-xs">Total Failed in INR</p>
              <p className="poppins-semibold text-lg">₹ {stats.total_failed}</p>
              <p className="text-[#E45757] text-xs">
                -<span className="poppins-semibold">{stats.total_failed} </span>
                <span className="">Today</span>
              </p>
            </div>
            <div className="flex gap-4 items-center">
      ...
      {reportIndex === 2 && (
        <div className="flex flex-col gap-1">
          <div className="flex items-center justify-between  bg-white py-3 px-5 rounded-2xl h-[6rem]">
            <div className="flex flex-col gap-1">
              <p className="text-[#A3A6A9] text-xs">Total Paid in INR</p>
              <p className="poppins-semibold text-lg">₹ {stats.today_paid}</p>
              <p className="text-[#E45757] text-xs">
                -<span className="poppins-semibold">{stats.today_paid} </span>
                <span className="">Today</span>
              </p>
            </div>
            <div className="flex gap-4 items-center">
