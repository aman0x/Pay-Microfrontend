                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex justify-center items-center bg-white rounded-2xl py-[0.8rem] gap-4">
                        <div>
                            ...
                            <rect x="0.75" width="51" height="51" rx="25.5" fill="url(#paint0_linear_855_15379)" fillOpacity="0.15"/>
                    ...
                    <div className="flex justify-center items-center  bg-white rounded-2xl py-[0.8rem] gap-4">
                        <div>
                            ...
                            <rect x="0.25" width="51" height="51" rx="25.5" fill="url(#paint0_linear_855_15386)" fillOpacity="0.15"/>
