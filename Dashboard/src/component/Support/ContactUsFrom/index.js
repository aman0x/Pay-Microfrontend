...
function ContactForm() {
  ...
  return (
    <div className="mt-5 bg-primary p-5 rounded-2xl flex flex-col gap-4 mb-4 mr-2">
      <div>
        <div className="poppins-semibold text-lg mb-1">Contacts</div>
        <div className="text-xs poppins-light text-[#A3A6A9]">
          Use The Form Below to Sent Message to Our Support Center
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <div className="flex gap-2">
          <input
            ...
            className=" bg-white italic text-xs border border-gray-300 text-gray-900 rounded-xl w-full ps-14 p-[1rem] placeholder:text-[#787D81]"
        ...
        <div className="relative">
          <div className="absolute bottom-4 right-4 italic text-xs text-[#787D81]">
            {wordsCount}/600
          </div>
          <textarea
            value={message}
            ...
            className=" bg-white text-xs border italic border-gray-300 text-gray-900 rounded-xl w-full p-3.5 resize-none placeholder:text-[#787D81] h-36"
            placeholder="Message"
          />
        </div>
      </div>
      <div className="">
        <button
          ...
          className="flex w-60 lg:w-72 primary-btn items-center justify-center rounded-xl bg-gray-950 px-3 p-4 text-sm font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        >
          Send
        </button>
      </div>
          ...
          <div className="flex justify-center items-center bg-white rounded-2xl py-[0.8rem] px-4 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="poppins-regular text-xs">
                {supportInfo.operante}, {supportInfo.time_we_operate}
              </div>
            </div>
          </div>
          <div className="flex justify-center items-center  bg-white rounded-2xl py-[0.8rem] px-4 gap-4">
            <div>
              ...
              >
                <rect
                  ...
                  height="51"
                  rx="25.5"
                  fill="url(#paint0_linear_855_15386)"
                  fill-opacity="0.15"
                />
                <path
                  d="M34.2193 20.8904L28.6073 26.2473C27.9816 26.8431 27.1338 27.1777 26.25 27.1777C25.3662 27.1777 24.5184 26.8431 23.8927 26.2473L18.2807 20.8904C18.2713 20.9909 18.25 21.0819 18.25 21.1818V28.8182C18.2511 29.6617 18.6026 30.4705 19.2275 31.067C19.8524 31.6634 20.6996 31.999 21.5833 32H30.9167C31.8004 31.999 32.6476 31.6634 33.2725 31.067C33.8974 30.4705 34.2489 29.6617 34.25 28.8182V21.1818C34.25 21.0819 34.2287 20.9909 34.2193 20.8904Z"
                  fill="url(#paint1_linear_855_15386)"
                />
                <path
                  d="M27.6647 25.3475L33.754 19.5343C33.459 19.0674 33.043 18.6809 32.546 18.4122C32.049 18.1435 31.4879 18.0015 30.9167 18H21.5833C21.0122 18.0015 20.451 18.1435 19.954 18.4122C19.457 18.6809 19.041 19.0674 18.746 19.5343L24.8353 25.3475C25.2111 25.7047 25.7197 25.9052 26.25 25.9052C26.7803 25.9052 27.289 25.7047 27.6647 25.3475Z"
                  fill="url(#paint2_linear_855_15386)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_855_15386"
                    x1="-7.88078"
                    y1="30.0333"
                    x2="59.7478"
                    y2="14.558"
