            ...
            <div className="flex flex-col gap-2 mt-2 p-[1rem] border-r-2">
                {
                    ...
                    <button className="flex justify-between items-center bg-black-primary rounded-xl py-[6px] px-3 poppins-medium text-sm w-48" onClick={() => { }}>
                        ...
                        <span>
                            ...
                            <path d="M1 4H8M8 4L4.88889 1M8 4L4.88889 7" stroke="white" stroke-linecap="round"/>
                            </svg>
                        </span>
                    </button>
                    </div>
