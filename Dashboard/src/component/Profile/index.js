            ...
            <div className="flex flex-col gap-2 mt-2 p-[2rem] pr-[2rem] border-r-2">
                {
                    ...
                    <button className="flex justify-between items-center bg-black-primary rounded-xl py-[6px] px-2 poppins-medium text-sm w-48" onClick={() => { }}>
                        <span>Profile</span>
                        <span>
                ...
                <div className="grid grid-cols-2  gap-10">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">First Name</label>
                            <div className="relative">
                                <input type="text" name="first_name" value={values.first_name} onChange={handleChange} onBlur={handleBlur} placeholder="Name" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full focus:outline-none py-1 px-4" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Middle Name</label>
                            <div className="relative">
                                <input type="text" name="middle_name" value={values.middle_name} onChange={handleChange} onBlur={handleBlur} placeholder="Middle name" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4" />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Last Name</label>
                            <div className="relative">
                                <input type="text" name="last_name" value={values.last_name} onChange={handleChange} onBlur={handleBlur} placeholder="Last Name" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4" />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Nick Name</label>
                            <div className="relative">
                                <input type="text" name="nick_name" value={values.nick_name} onChange={handleChange} onBlur={handleBlur} placeholder="Nick Name" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4" />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Account Type</label>
                            <div className="relative">
                                <input type="text" name="account_type" value={values.account_type} onChange={handleChange} onBlur={handleBlur} placeholder="Account Type" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4 " />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Phone</label>
                            <div className="relative">
                                <input type="text" name="phone" value={values.phone} onChange={handleChange} onBlur={handleBlur} placeholder="Phone" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4" />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Email</label>
                            <div className="relative">
                                <input type="text" name="email" value={values.email} onChange={handleChange} onBlur={handleBlur} placeholder="customer@email.com" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full py-1 focus:outline-none px-4 " />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                        ...
                        <div className="flex flex-col">
                            <label className="text-[#A3A6A9] poppins-regular text-xs ml-4 mb-1">Password</label>
                            <div className="relative">
                                ...
                                <input type="password" name="password" value={values.password} onChange={handleChange} onBlur={handleBlur} placeholder="**********" className="bg-transparent poppins-semibold text-[#4E5459] border-b-2 w-full px-9 py-1 focus:outline-none " />
                                <div className="absolute bottom-2 right-4">
                                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.5 13.6667V16.8C13.9705 16.6387 14.3987 16.3734 14.7527 16.024L16.5233 14.252C16.8732 13.8985 17.1387 13.4705 17.3 13H14.1667C13.9899 13 13.8203 13.0702 13.6953 13.1953C13.5702 13.3203 13.5 13.4899 13.5 13.6667Z" fill="#CDCED1" />
                                        <path d="M6.28133 10.2186C6.03361 10.4662 5.83711 10.7603 5.70305 11.0839C5.56898 11.4075 5.49999 11.7543 5.5 12.1046V12.9999H6.39533C6.74561 12.9999 7.09246 12.9309 7.41606 12.7969C7.73967 12.6628 8.03369 12.4663 8.28133 12.2186L15.8333 4.66659C16.0985 4.40137 16.2475 4.04166 16.2475 3.66659C16.2475 3.29152 16.0985 2.93181 15.8333 2.66659C15.5681 2.40137 15.2084 2.25238 14.8333 2.25238C14.4583 2.25238 14.0985 2.40137 13.8333 2.66659L6.28133 10.2186Z" fill="#CDCED1" />
                    ...
                    <div className="primary-linear-gr-bg p-[1.5px] rounded-xl shadow-red-200 shadow-2xl max-w-fit">
                        <button type="button" className="flex justify-between items-center bg-primary rounded-xl py-[10px] px-5 poppins-medium text-xs  gap-2" onClick={() =>  handleSubmit()}>
                        <span>
                ...
                <div className="flex flex-col justify-between w-full h-full">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2 items-center poppins-light text-[#A3A6A9] max-w-96">
                            ...
                            <div className="text-sm pt-1 items-center" >{isDataShown?kycDetail.name:'***********'}</div>
                        </div>
                        <div className="flex gap-2 items-center poppins-light text-[#A3A6A9] max-w-96">
                            <div className="">Region</div>
                            <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                            <div className="text-sm pt-1 items-center">{isDataShown?kycDetail.region:'***********'}</div>
                        </div>
                    </div>

                    <div className="flex flex-col gap-2 mt-4">
                        <div className="poppins-semibold  mb-2">Uploaded Documents:</div>
                        <div className="flex gap-2 items-center poppins-light text-[#A3A6A9] max-w-96">
                            <div className="">Name</div>
                            <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                            <div className="text-sm pt-1 items-center">{isDataShown?kycDetail.document_name:'***********'}</div>
                        </div>
                        <div className="flex gap-2 poppins-light items-center text-[#A3A6A9] max-w-96">
                            <div className="min-w-fit">Document ID</div>
                            <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                            <div className=" text-sm pt-1 items-center">{isDataShown?kycDetail.document_id:'***********'}</div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2 mt-4">
                        <div className="poppins-regular text-[#A3A6A9]">Document Scan / Photo</div>
                        {
                            !isDataShown?
                    ...
                    <div className="mt-4"> 
                        <div className="primary-linear-gr-bg p-[1.5px] rounded-xl shadow-red-200 shadow-2xl max-w-fit">
                            <button className="flex justify-between items-center bg-primary rounded-xl py-[10px] px-5 poppins-medium text-xs  gap-2" 
