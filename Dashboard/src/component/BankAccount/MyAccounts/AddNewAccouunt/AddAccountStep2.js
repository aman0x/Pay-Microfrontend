...
function AddNewAccountStep2({data}){
    ...
    return(
        <div className="flx flex-col">
                <div className="text-center poppins-semibold text-[#232B31]">Confirm Details</div>
            ...
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm">Name</div>
            ...
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm">Type</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
            ...
            <div className="flex flex-col gap-1">
                <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm min-w-fit">A/C No</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                    <div className="poppins-semibold text-sm">{data.account_number}</div>
            </div>
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm">Bank</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                    <div className="poppins-semibold text-sm min-w-fit">{data.bank_name}</div>
            </div>
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm min-w-fit">IFS Code</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                    <div className="poppins-semibold text-sm">{data.ifsc_code}</div>
            </div>
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm min-w-fit">Bank Account Type</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                    <div className="poppins-semibold text-sm">{data.account_type_2}</div>
            </div>
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm min-w-fit">PAN</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                    <div className="poppins-semibold text-sm">{data.pan_no}</div>
            </div>
            <div className="flex gap-2 items-center">
                    <div className="text-[#A3A6A9] poppins-regular text-sm min-w-fit">GSTIN</div>
                    <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
            ...
            <div className='w-[40%] mx-auto '>
                    <button type="submit"
                        ...
                        className="flex primary-btn items-center w-full justify-center rounded-xl bg-[#232B31] px-3 p-4 text-sm font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><div>{"Confirm And Add"}</div>
