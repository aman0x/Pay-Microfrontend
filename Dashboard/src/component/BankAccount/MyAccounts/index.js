            ...
            <div className="md:hidden w-full">
                <div className="p-4 ">
                    ...
                    <div className="flex flex-col w-full items-center my-2 gap-2">
                        {banks.map((bank) => {
                            return (
                                <div className="bg-white rounded-3xl w-full shadow-sm p-5 mb-4">
                                    <div className="flex justify-between">
                                        ...
                                        <div onClick={() => null}>
                                            <svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.6667 3.16666H10.6C10.281 1.61572 8.91672 0.502 7.33331 0.5H5.99997C4.41656 0.502 3.05225 1.61572 2.73331 3.16666H0.666656C0.298469 3.16666 0 3.46513 0 3.83331C0 4.2015 0.298469 4.5 0.666656 4.5H1.33331V13.1667C1.33553 15.0067 2.82663 16.4978 4.66666 16.5H8.66666C10.5067 16.4978 11.9978 15.0067 12 13.1667V4.5H12.6667C13.0348 4.5 13.3333 4.20153 13.3333 3.83334C13.3333 3.46516 13.0348 3.16666 12.6667 3.16666ZM6 11.8333C6 12.2015 5.70153 12.5 5.33334 12.5C4.96512 12.5 4.66666 12.2015 4.66666 11.8333V7.83334C4.66666 7.46516 4.96512 7.16669 5.33331 7.16669C5.7015 7.16669 5.99997 7.46516 5.99997 7.83334V11.8333H6ZM8.66666 11.8333C8.66666 12.2015 8.36819 12.5 8 12.5C7.63181 12.5 7.33334 12.2015 7.33334 11.8333V7.83334C7.33334 7.46516 7.63181 7.16669 8 7.16669C8.36819 7.16669 8.66666 7.46516 8.66666 7.83334V11.8333ZM4.114 3.16666C4.39756 2.36819 5.15269 1.83434 6 1.83331H7.33334C8.18066 1.83434 8.93578 2.36819 9.21934 3.16666H4.114Z" fill="#E45757" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="mt-3 flex flex-col gap-1" >
                                        <div className="flex w-full items-center">
                                            ...
                                            <div className="poppins-bold text-[#787D81]">{bank.account_number || "235463636346"}</div>
                                        </div>
                                        <div className="flex w-full items-center">
                                            <div className="poppins-regular text-[#A3A6A9]">IFS Code:</div>
                                            <hr className="border-t-2 border-dashed border-[#CDCED1] flex-grow mx-1" />
                                            <div className="poppins-bold text-[#787D81]">{bank.ifsc_code || "HDFC09241"}</div>
                                        </div>
                                    </div>
                                </div>
                            )
