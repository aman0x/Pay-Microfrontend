...
function PaymentTable({ handlePaymentData }) {
  ...
  return (
    // <div>
    //   <div className="sm:flex gap-3 poppins-regular text-[14px] sm:items-center mt-2">
    //     <div className="poppins-semibold text-sm text-[#787D81]">
    //       Show:
    //     </div>
    ...
    //       </div>
    //       <div className={`${filterIndex === 0 ? "text-[#232B31]" : "text-[#A3A6A9]"}`}>Succeeded</div>
    //     </div>
    //     <div className="flex gap-2 items-center">
    ...
    //       </div>
    //       <div className={`${filterIndex === 1 ? "text-[#232B31]" : "text-[#A3A6A9]"}`}>InProgress</div>
    //     </div>
    //     <div className="flex gap-2 items-center">
    //       <div className={`max-w-[16px]  max-h-[16px] rounded-sm   ${filterIndex === 2 ? "primary-linear-gr-bg" : "bg-gray-300"}`}>
    //         <FaSquare color={`${filterIndex === 2 ? "black" : "white"}`} className="rounded-sm p-[1px]" onClick={() => setFilterIndex(2)} />
    //       </div>
    //       <div className={`${filterIndex === 2 ? "text-[#232B31]" : "text-[#A3A6A9]"}`}>Failed</div>
    //     </div>
    //     <div className="flex gap-2 items-center">
    //       <div className={`max-w-[16px]  max-h-[16px] rounded-sm   ${filterIndex === 3 ? "primary-linear-gr-bg" : "bg-gray-300"}`}>
    //         <FaSquare color={`${filterIndex === 3 ? "black" : "white"}`} className="rounded-sm p-[1px]" onClick={() => setFilterIndex(3)} />
    //       </div>
    //       <div className={`${filterIndex === 3 ? "text-[#232B31]" : "text-[#A3A6A9]"}`}>Refunded</div>
    //     </div>
    //     <div className="flex">
    //       <div className="w-80 sm:mx-4">
    //         <div className="relative w-full">
    //           <input type="text" id="voice-search" className="bg-[#F0F1F2] border border-gray-300 text-gray-900 text-sm rounded-2xl block w-full p-2.5 poppins-light-italic" placeholder="Search for Payments ..." required />
      ...
      <div className="w-full mt-2  overflow-x-auto ">
        <table className="w-full  rounded-2xl overflow-hidden ">
          <tr className="poppins-light text-xs text-white bg-[#232B31] items-center">
            ...
            <td>
              <div className="td-element1 text-[10px]">Beneficiary</div>
            </td>
            <td>
              <div className="td-element1 text-[10px]">Type</div>
            </td>
