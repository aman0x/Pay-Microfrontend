         ...
         <div className="sm:flex gap-3 poppins-light text-[14px] sm:items-center mt-2">
                ...
                <div className="flex gap-2 items-center">
                  <div className={`max-w-[16px]  max-h-[16px] rounded-sm   ${filterIndex===0?"primary-linear-gr-bg":"bg-gray-300"}`}>
                    ...
                    <div className={`${filterIndex===0?"poppins-bold":""}`}>Succeeded</div>   
                  </div>
                <div className="flex gap-2 items-center">
                  <div className={`max-w-[16px]  max-h-[16px] rounded-sm   ${filterIndex===1?"primary-linear-gr-bg":"bg-gray-300"}`}>
                    ...
                    <div className={`${filterIndex===1?"poppins-bold":""}`}>InProgress</div>
                  </div>
                <div className="flex gap-2 items-center">
                  <div className={`max-w-[16px]  max-h-[16px] rounded-sm   ${filterIndex===2?"primary-linear-gr-bg":"bg-gray-300"}`}>
                    ...
                    <div className={`${filterIndex===2?"poppins-bold":""}`}>Failed</div>
                  </div>
                <div className="flex gap-2 items-center">
                ...
                <div className="w-80 sm:mx-4">
                  <div className="relative w-full">
                      <input type="text" id="voice-search" className="bg-[#DFE0E2] border border-gray-300 text-gray-900 text-sm rounded-2xl block w-full  p-2" placeholder="Search for Payments..."  />
