                ...
                <div className="bg-[#FFFFFF] p-6 rounded-3xl flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            {isCardMenuOpen && <CardsMenu cards={card} cardIndex={cardIndex} setCardIndex={setCardIndex} setCardMenuOpen={setCardMenuOpen} setPaymentDetail={setPaymentDetail}/>}
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="text-[#4E5459] text-sm poppins-semibold">Contact Details:</div>
                          <div>
                           <div className="flex gap-2 items-center">
                                ...
                                <div className="poppins-semibold text-xs">{data.receiver.phone_number}</div>
                           </div>
                           <div className="flex gap-2 items-center">
                                <div className="text-[#A3A6A9] text-xs">Mail</div>
                                <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]"/>
                                <div className="poppins-semibold text-xs">{data.receiver.email}</div>
                           </div>
                        </div>
...
function CardsMenu({cardIndex,setCardIndex,cards,setCardMenuOpen,setPaymentDetail}){
