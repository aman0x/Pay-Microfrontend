  ...
  return (
    <div className="bg-primary mt-1 rounded-2xl flex flex-col gap-3 w-full ">
      <div className="flex flex-col gap-4 mb-20 md:mb-0">
        <div className="text-center poppins-semibold text-sm text-[#232B31]">
          Payment Details
        </div>
          ...
          <div className="bg-[#FFFFFF] p-6 rounded-3xl flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between border-2 border-[#DFE0E2] p-2 rounded-xl">
                <div className="flex gap-1 items-center">
                  ...
                  <div>{maskCardNumber(card[cardIndex]?.card_no)}</div>
                </div>
            ...
            <div className="flex flex-col gap-2">
                    ...
                    <div className="rounded-[50%] p-4   bg-[#f190af69] ">
                      ...
                      >
                        <path
                          ...
                          fill="url(#paint0_linear_1279_5575)"
                        />
                        <defs>
                          <linearGradient
                            id="paint0_linear_1279_5575"
                            x1="-2.55083"
                            y1="9.92222"
                            x2="18.666"
                            y2="5.06723"
              ...
              >
                <div
                  className={`flex justify-between ${
                    paymentIndex === 1 ? "isactive" : "bg-[#F0F1F2]"
                  } rounded-2xl w-full items-center p-4`}
                >
                  <div className="flex flex-col">
                    <div className="color-linear text-sm poppins-bold">
              ...
              >
                <div
                  className={`flex justify-between ${
                    paymentIndex === 2 ? "isactive" : "bg-[#F0F1F2]"
                  } rounded-2xl w-full items-center p-4`}
                >
                  <div className="flex flex-col">
                    <div className="color-linear text-sm poppins-bold">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-col gap-2 bg-white rounded-2xl p-6 ">
              ...
              <div>
                ...
                <div className="flex gap-2 items-center">
                  <div className="text-[#A3A6A9] text-xs min-w-fit">
                    IFS Code
                  </div>
                  <hr className="my-2 w-full border-t-2 border-dashed border-[#CDCED1]" />
            ...
            <div className="flex flex-col gap-3 bg-white rounded-2xl p-6 ">
              <div className="poppins-semibold text-base">Supplier Payment</div>
              <div className="text-[#4E5459] text-xs poppins-semibold">
            ...
            <span>
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M16.25 8.5C16.25 12.9182 12.6682 16.5 8.25 16.5C3.83172 16.5 0.25 12.9182 0.25 8.5C0.25 4.08172 3.83172 0.5 8.25 0.5C12.6682 0.5 16.25 4.08172 16.25 8.5ZM11.4742 6.07574C11.7086 6.31005 11.7086 6.68995 11.4742 6.92424L7.47424 10.9242C7.23992 11.1586 6.86008 11.1586 6.62574 10.9242L5.02574 9.32424C4.79142 9.08992 4.79142 8.71008 5.02574 8.47576C5.26005 8.24144 5.63995 8.24144 5.87426 8.47576L7.05 9.65144L8.83784 7.8636L10.6258 6.07574C10.8601 5.84142 11.2399 5.84142 11.4742 6.07574Z"
                  fill="#4E5459"
                />
              </svg>
            </span>
