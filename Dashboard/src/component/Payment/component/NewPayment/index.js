...
function NewPayment({ isRepeatPayment = false }) {
  ...
  const { handleGetBankById, handleGetBeneficiary ,handleGetInvoiceService } = useAccounts();
...
export function PaymentTypeMenu({
  ...
  return (
    <div
      className="absolute w-[100%] top-12 bg-white rounded-2xl shadow-lg py-[1rem] px-[1.2rem] gap-4 z-50"
      onClick={() => {
        setTimeout(() => {
