  ...
  return (
    <div className="mb-[2rem]">
      <div className="flex justify-between mb-5 items-center gap-6">
        ...
        <hr className="flex-1 poppins-bold text-gray-950" />
      </div>
      <div className="flex gap-4">
        <div className="w-[30%] mr-2 flex-col">
          <div className="poppins-semibold text-gray-600 mb-5 text-sm">
            Show Actions :
          </div>
          <div className="primary-linear-gr-bg-up p-[1.5px] rounded-xl shadow-2xl">
            <div className="flex justify-between items-center bg-black-primary rounded-xl py-2 px-3">
              ...
              <div>
                <FaArrowRight color="white" size="10px" />
              </div>
            </div>
          </div>
          <FilterComponent />
          <div className="my-4">
            <a
              ...
              className="underline text-[#787D81] poppins-regular text-xs cursor-pointer"
            >
              Go to All Payments
            </a>
          </div>
              ...
              <span>
                ...
                >
                  <g clipPath="url(#clip0_855_4415)">
                    ...
                    />
                    <path
                      d="M7.99984 9.77783L7.99984 4.4445M7.99984 4.4445L10.6665 7.11117M7.99984 4.4445L5.33317 7.11117"
                      stroke="#B6B8BA"
