...
function AddCard(){
    ...
    const handleSubmit = ()=>{
        if(cardHolderName.length>3 && cardCVV.length===3 && cardExpDate.length>0 && cardNumber.replace(/\s+/g, '').length===16){
           handleAddCard(
            {
            ...
            <div className="mx-auto w-[35%] flex flex-col gap-8 mt-8">
                    <div className="text-center poppins-semibold">Enter Data</div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                <input type="text" value={cardHolderName} onChange={(e)=>setCardHolderName(e.target.value)}  className="bg-white border border-gray-300 text-gray-900 text-sm rounded-2xl w-full ps-14 p-3.5" placeholder="Card Holder Name"/>
                                {
                                    !isValid?
                                    <div className="absolute inset-y-0 end-1 flex items-center pe-3">
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                    ...
                                    maskChar=""
                                    >
                                    {(inputProps) => <input {...inputProps} type="text" className=" bg-white border border-gray-300 text-gray-900 text-sm rounded-2xl w-full ps-14 p-3.5"/>}
                                    </InputMask>
                                <div className="relative">
                                <input type="number"
                                 value={cardCVV} 
                                 ...
                                 className=" bg-white border border-gray-300 text-gray-900 text-sm rounded-2xl w-full ps-14 p-3.5" placeholder="CVV"/>
                                {
                                    !isValid?
                                    <div className="absolute inset-y-0 end-1 flex items-center pe-3">
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
