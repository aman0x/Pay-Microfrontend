...
function AddNewBeneficiary({isRepeatPayment=false}){
    ...
    return(
        <div className="mt-5 bg-primary p-[2rem] rounded-2xl flex flex-col gap-3 w-full min-h-[500px]">
            ...
            {
                stepIndex===1 && 
                <AddBenficiaryBank data={{
                    name:accountName,
                    phone_number:accountNumber
                }} handleSubmitBank={handleBankData}/>
            }

            {
                stepIndex===2 &&
                <AddBeneficiaryStep2 data={finalData}/> 
            }
